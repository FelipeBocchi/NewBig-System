...
public class TelaCliente extends javax.swing.JFrame {
     ...
     */
    public TelaCliente(HelpService helpService, BatchControllerInterface batchController) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaCliente(new HelpService(), new BatchControllerImpl()).setVisible(true));
